...
Implementation
Check ui-context.md for the node color palette. Each palette option includes:
...
Add a toolbar above selected nodes.
...
no server calls
Selected nodes should visually reflect their active color pair.
