...
@vercel/blob
Implementation
Check the existing project schema.

review prisma/model/project.prisma
add or reuse a field for the canvas blob URL
keep Prisma responsible for metadata only
Add canvas save/load API routes. Create: PUT /api/projects/[projectId]/canvas This route should:
...
Add a small save status indicator in the editor Save button.
