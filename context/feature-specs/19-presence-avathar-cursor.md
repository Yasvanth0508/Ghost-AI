...
Implementation
Keep the existing navbar behavior as-is.
...
Add the participant avatar group inside the editor canvas area.
...
Add live cursors to the canvas.
...
Define the shared presence type in liveblocks.config.ts.
